...
variable "tenancy_ocid" {
  ...
  type        = string
  default = "ocid1.tenancy.oc1..aaaaaaaaxzpxbcag7zgupiz7a"
}

variable "user_ocid" {
  description = "The OCID of the user calling the API."
  type        = string
  default = "ocid1.user.oc1..aaaaaaaawlmnpsv76aspbgpq"
}
...
variable "compartment_ocid" {
  ...
  type        = string
  default = "ocid1.compartment.oc1..aaaaaaaaau5krrtg34a"
}
...
variable "windows_password" {
  ...
  type        = string
  default     = "GOAD@dm!n2023#"  # You should change this in production
  sensitive   = true
}

variable "ssh_public_key_path" {
  description = "Path to SSH public key for Linux instances"
  type        = string
  default     =  "ssh-rsa  alexandru_@419d0b8d7292"
}
