...
variable "tenancy_ocid" {
  ...
  type        = string
  default = "ocid1.tenancy.oc1..aaaaaYourOCID"
}

variable "user_ocid" {
  description = "The OCID of the user calling the API."
  type        = string
  default = "ocid1.user.oc1..aaaaaaaaYourOCID"
}

variable "fingerprint" {
  description = "The fingerprint of the API key."
  type        = string
  default = "YourKeyFingerpring"
}
...
variable "compartment_ocid" {
  ...
  type        = string
  default = "ocid1.compartment.oc1..aaaaaaaaYourCompartmentID"
}
